...
- Rename `/web/.env.local.test` to `/web/.env.local` and update newly-generated Sanity project ID and preview secret
- Update the project names in `/studio/package.json` and `/web/package.json`
